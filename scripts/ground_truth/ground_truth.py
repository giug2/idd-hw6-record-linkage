...
def main():
    ...
    # Ricostruzione Record Positivi (Match = 1)
    ...
    # Creazione DataFrame Finale e Ordinamento Colonne
    ...
    print(f"\nIl dataset è pronto: {len(df_final)} record totali.")
